  ...
  return (
    <div id="about">
      <div className={styles.info}>
        ...
        <p>
          Cemetery hours of operation are sunrise to sunset, seven days a week.
        </p>
        <p>
        ...
        <p>
          ...
          that’s been continuously incorporated in Washington State since March
          20, 1889 and recognize by the Washington Secretary of State as a
          Pioneer Corporation during the Washington Centennial in 1989.
        </p>
      </div>
    </div>
  );
